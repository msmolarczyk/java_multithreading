    ...
    private static class PhaserTask implements Runnable {
        ...
        public void run() {
            ...
            if (phaser.getPhase() == arr1) {
                System.out.println(taskId + " completed phase " + arr1 + " and waiting arraival of " + unarrivedParties1
                        + " threads so that it can enter phase " + (arr1 + 1));
            } else {
                System.out.println(taskId + " completed phase " + (arr1) + " (the last one to reach) and now all tasks will proceed to phase " + (arr1 + 1));
            }
            ...
            if (phaser.getPhase() == arr2) {
                System.out.println(taskId + " completed phase " + arr2 + " and waiting arraival of " + unarrivedParties2
                        + " threads so that it can enter phase " + (arr2 + 1));
            } else {
                System.out.println(taskId + " completed phase " + (arr2) + " (the last one to reach) and now all tasks will proceed to phase " + (arr2 + 1));
            }
